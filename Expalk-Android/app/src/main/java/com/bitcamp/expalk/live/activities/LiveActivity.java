...
import com.bitcamp.expalk.data.FeedbackData;
import com.bitcamp.expalk.dialog.DialogConnection;
import com.bitcamp.expalk.dialog.DialogProgress;
import com.bitcamp.expalk.live.stats.LocalStatsData;
import com.bitcamp.expalk.live.stats.RemoteStatsData;
import com.bitcamp.expalk.live.stats.StatsData;
import com.bitcamp.expalk.live.ui.VideoGridContainer;
...
public class LiveActivity extends RtcBaseActivity implements RatingDialogListener, DialogConnection.OnDismissConnection {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences(com.bitcamp.expalk.util.Constants.MY_PREF, Context.MODE_PRIVATE);
        txtTimer = findViewById(R.id.txtLiveTimer);

        allot_time = Integer.parseInt(getIntent().getStringExtra("allot_time")) * 60000;

        config().setChannelName(sharedPreferences.getString(com.bitcamp.expalk.util.Constants.UID, "guest"));
        initUI();
        initData();
    }
    ...
    private void initData() {
        mVideoDimension = com.bitcamp.expalk.live.Constants.VIDEO_DIMENSIONS[
    ...
    private void showDialog() {
        new AppRatingDialog.Builder()
                ...
                .setDefaultRating(3)
                .setTitle("Rate Mentor/Mentee")
                .setDescription("Your feedback is important to us in order to understand your Mentor/Mentee and maintain the usefulness of the platform.")
    ...
    public void onNegativeButtonClicked() {
        ...
        if(sharedPreferences.getString(com.bitcamp.expalk.util.Constants.UID,"guest")
                .equals(sharedPreferences.getString(com.bitcamp.expalk.util.Constants.CONNECT_TO,"guest"))){
            dialogConnection = new DialogConnection(sharedPreferences.getString(com.bitcamp.expalk.util.Constants.CONNECTED_TO,"guest"), LiveActivity.this);
        }else{
            dialogConnection = new DialogConnection(sharedPreferences.getString(com.bitcamp.expalk.util.Constants.CONNECT_TO,"guest"), LiveActivity.this);
        }
    ...
    public void onPositiveButtonClicked(int i, @NotNull String s) {
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference("Feedback/"+sharedPreferences.getString(com.bitcamp.expalk.util.Constants.UID,"guest"));
        Calendar calendar = Calendar.getInstance();
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
        String time = simpleDateFormat.format(calendar.getTime());

        FeedbackData feedbackData = new FeedbackData(String.valueOf(i),s,time,sharedPreferences.getString(com.bitcamp.expalk.util.Constants.CONNECT_TO, "guest"), sharedPreferences.getString(com.bitcamp.expalk.util.Constants.CONNECTED_TO,"guest"));
